...
public class MaterialsMod {
    ...
    /* ARMOR */
    public static final ItemArmor.ArmorMaterial TYROLIUM_ARMOR = EnumHelper.addArmorMaterial("tyrolium_armor", Global.MODID + ":tyrolium", 35, new int[]{4,9,7,4},99, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.0F);
